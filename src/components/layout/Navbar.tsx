...
export default function Navbar() {
  ...
  useEffect(() => {
    // Only check saved theme preference, default to light if none
          ...
          <div className="flex justify-between items-center h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="flex items-center space-x-4 ml-6">
                ...
                <a
                  href="#contact"
                  className="px-4 py-2 bg-gradient-to-r from-pink-500 to-orange-400 text-white rounded-full font-semibold shadow hover:opacity-90 transition"
                >
                  Hire Me
                </a>
              </div>
        ...
        >
          <div className="px-2 pt-2 pb-4 space-y-2 bg-white dark:bg-dark-light rounded-md shadow-lg mx-4">
            ...
            <a
              href="#contact"
              onClick={() => setIsOpen(false)}
              className="block text-center px-4 py-2 bg-gradient-to-r from-pink-500 to-orange-400 text-white rounded-full font-semibold shadow hover:opacity-90 transition"
            >
              Hire Me
            </a>
