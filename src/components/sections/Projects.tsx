  ...
  const projects = [
    {
      ...
      description: "Full-stack inventory management platform for sales and expenses with web scraping.",
              ...
              <div className="p-5">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {project.technologies.map((tech) => (
                    <span key={tech} className="bg-gradient-to-r from-purple-300 to-pink-300 dark:from-purple-700 dark:to-pink-700 px-2 py-1 rounded text-xs text-gray-800 dark:text-gray-100">
                      {tech}
                    </span>
                  ))}
                </div>
